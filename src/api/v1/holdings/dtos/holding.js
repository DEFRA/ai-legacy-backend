...
class HoldingDto {
   ...
   * @param {Holding} _holding - Holding domain model
   * @returns {HoldingDto} DTO instance
   */
  static fromModel (_holding) {
   ...
   */
  static fromModelSummary (_holding) {
   ...
   * @param {Holding[]} _holdings - Array of Holding models
   * @returns {HoldingDto[]} Array of DTOs
   */
  static fromModels (_holdings) {
